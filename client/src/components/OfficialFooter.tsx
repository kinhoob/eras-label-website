    ...
    <footer className="site-footer official-footer" aria-label="Rodapé da Eras Label">
      ...
      <div className="footer-grid">
        <nav className="footer-column" aria-label="Navegação principal">
          ...
          <Link href="/" onClick={interact} className={linkClass}>Início</Link>
          <Link href="/#shop" onClick={interact} className={linkClass}>Produtos</Link>
          <Link href="/collection/paradox" onClick={interact} className={linkClass}>Coleções</Link>
          <Link href="/category/camisetas" onClick={interact} className={linkClass}>Camisetas</Link>
          <Link href="/category/bones" onClick={interact} className={linkClass}>Bonés</Link>
        </nav>

        <nav className="footer-column" aria-label="Informações da loja">
          <strong>INFORMAÇÕES</strong>
          <Link href="/contact" onClick={interact} className={linkClass}>Contato</Link>
          <Link href="/shipping" onClick={interact} className={linkClass}>Envios</Link>
          <Link href="/privacy" onClick={interact} className={linkClass}>Política de Privacidade</Link>
          <Link href="/about" onClick={interact} className={linkClass}>Quem Somos</Link>
          <Link href="/returns" onClick={interact} className={linkClass}>Trocas e Devoluções</Link>
          <Link href="/faq" onClick={interact} className={linkClass}>Perguntas Frequentes</Link>
          <Link href="/tracking" onClick={interact} className={linkClass}>Rastrear pedido</Link>
        </nav>
