  ...
  return (
    <>
      ...
      <div className={`public-global-nav ${isHome ? "public-global-nav--home" : ""} ${isVisible ? "is-visible" : "is-hidden"}`} role="banner">
        ...
        <Link href="/" className="public-global-brand" aria-label="Voltar para a loja Eras Label"><img src="/eras-logo-sticker.webp" alt="Eras Label" style={{ height: "46px", width: "auto", objectFit: "contain", display: "block" }} /></Link>
