  ...
  return (
    <div className="admin-shell">
      <aside className={`admin-sidebar ${menuOpen ? "open" : ""}`}>
        <div className="admin-brand"><Link href="/"><img src="/eras-logo-sticker.webp" alt="Eras Label Admin" style={{ height: "26px", width: "auto", objectFit: "contain", display: "block" }} /></Link><small>ADMIN</small></div>
